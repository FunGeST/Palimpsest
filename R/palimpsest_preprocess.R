...
preprocessInput_sv_2 = function (input_data = NULL, Sample.col = "Sample", CHROM_1.col = "CHROM_1",
                                 ...
                                 type.col = "Type",resdir = resdir, genome_build = "hg19")
{
  ...
  vcf <- palimpsest_addSVcategoriesToVcf_2(vcf, type.col = type.col,
...
palimpsest_addSVcategoriesToVcf_2 = function (sv = sv, type.col = "Type", sample.col = "Sample",
